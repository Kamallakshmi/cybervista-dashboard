...
export function HeroSectionWithBeamsAndGrid() {
  ...
  return (
    ...
    >
      ...
      <h2 className="relative z-50 mx-auto mb-4 mt-4 max-w-4xl text-balance text-center text-3xl font-semibold tracking-tight text-black md:text-7xl dark:text-neutral-300">
        <Balancer>
      ...
      <p className="relative z-50 mx-auto mt-4 max-w-lg px-4 text-center text-base/6 text-gray-600 dark:text-gray-200">
        Monitor device threats, MFA usage, login failures, and global attack
        trends with one powerful interactive dashboard.
      </p>
      <div className="mb-10 mt-8 flex w-full items-center justify-center px-8 md:mb-20">
        {/* <button
          onClick={() => navigate("/dashboard")}
          className="group relative z-20 flex h-10 w-full max-w-xs cursor-pointer items-center justify-center space-x-2 rounded-lg bg-black px-4 py-2 text-center text-sm font-semibold leading-6 text-white no-underline transition duration-200 dark:bg-white dark:text-black"
        >
          Dashboard
        </button> */}
        <RainbowButtonDemo />
